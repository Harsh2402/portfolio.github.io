...
import 'package:harsh_portfolio/widget/serviceCard.dart';
                      ...
                      content: Column(
                        ...
                        children: [
                          CustomFilledBtn(
                            height: 40.0,
                            onPressed: () =>
                                launchURL("https://wa.me/?text=Hi Harsh!"),
                            btnColor: Color(0xff34CB62),
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(FontAwesomeIcons.whatsapp, size: 25.0),
